...
<head>
    ...
    <title>Networking Devices</title>
</head>
<body>
    <div class = "container">
        <h1>Networking Devices in the Database:</h1>
        <hr>
...
try {
    ...
    $stmt = $conn->prepare("SELECT `Name`, `Make`, `Model`, `Type`, `Specification`, `remarks` FROM `networking devices`");
    $stmt->execute();
