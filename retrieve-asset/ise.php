...
<body>
    <div class = "container">
        <h1>Identity Management Systems in the Database:</h1>
        <hr>
...
try {
    ...
    $stmt = $conn->prepare("SELECT `Name`, `Make`, `Model`, `Type`, `Specification`, `remarks` FROM `networking devices` WHERE `Name`='ISE'");
    $stmt->execute();
