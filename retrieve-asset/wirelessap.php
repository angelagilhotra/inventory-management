...
<head>
    ...
    <title>WirelessAP</title>
</head>
<body>
    <div class = "container">
        <h1>Wireless - AP in the Database:</h1>
        <hr>
...
try {
    ...
    $stmt = $conn->prepare("SELECT `Name`, `Make`, `Model`, `Type`, `Specification`, `remarks` FROM `networking devices` WHERE `Name`='wireless-AP'");
    $stmt->execute();
